...
// GET /api/services/idea-labs - Get Idea Labs service data from Supabase
  ...
  try {
    ...
    const projectProposals = gigs.map(gig => {
      ...
      return {
        ...
        created_by: {
          ...
          email: gig.created_by_user?.email || 'facilitator@idea-labs.exponentio.com',
    ...
    return NextResponse.json({
      service: {
        ...
        description: 'Transform ideas into reality with our innovation lab. We provide the tools, resources, and guidance to turn your creative concepts into viable products and solutions.',
        lab_name: lab.name,
    ...
    console.error('Error fetching Idea Labs service data:', error);
    return NextResponse.json(
